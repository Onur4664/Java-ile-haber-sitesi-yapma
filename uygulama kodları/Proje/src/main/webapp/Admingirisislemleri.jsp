...
<jsp:useBean id="islem" class="admınlogin.baglanti" scope="page"></jsp:useBean>
<jsp:useBean id="veri" class="admınlogin.getset" scope="page" ></jsp:useBean>
</head>
<body>
